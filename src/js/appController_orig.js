 ...
 */
define(['knockout', 'ojs/ojmodule-element-utils', 'ojs/ojresponsiveutils', 'ojs/ojresponsiveknockoututils', 'ojs/ojrouter', 'ojs/ojarraydataprovider', 'ojs/ojknockouttemplateutils', 'ojs/ojmodule-element', 'ojs/ojknockout', 'lte'],
        function (ko, moduleUtils, ResponsiveUtils, ResponsiveKnockoutUtils, Router, ArrayDataProvider, KnockoutTemplateUtils) {
            function ControllerViewModel() {
                ...
                self.toolbarConfig = ko.observable({'view': ['toolbar'], 'viewModel': 'toolbar'});
                ...
                self.custName = ko.observable('Customer Name')
                    ...
                    switch (event.target.value) {
                        ...
                        case "out":
                            ...
                            if (typeof (Storage) !== "undefined") {
                                localStorage.setItem("dmLoggedIn", false);
                                localStorage.removeItem("dmLoggedIn");
