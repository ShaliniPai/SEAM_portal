        ...
        copyCustomLibsToStaging: {
            fileList: [
                {cwd: 'node_modules/admin-lte/dist',
                    src: ['**'],
                    dest: 'web/js/libs/admin-lte'},
                {cwd: 'node_modules/bootstrap/dist',
                    src: ['**'],
                    dest: 'web/js/libs/bootstrap'},
                {cwd: 'node_modules/moment/min',
                    src: ['**'],
                    dest: 'web/js/libs/moment'},
                {cwd: 'node_modules/jquery-slimscroll',
                    src: ['**'],
                    dest: 'web/js/libs/jquery-slimscroll'},
                {cwd: 'node_modules/bootbox/dist',
                    src: ['**'],
                    dest: 'web/js/libs/bootbox'},
                {cwd: 'node_modules/daterangepicker',
                    src: ['**'],
                    dest: 'web/js/libs/daterangepicker'},
                {cwd: 'node_modules/bootstrap-datepicker/dist',
                    src: ['**'],
                    dest: 'web/js/libs/bootstrap-datepicker'},
                {cwd: 'node_modules/font-awesome',
                    src: ['**'],
                    dest: 'web/js/libs/font-awesome'},
                {cwd: 'node_modules/@google/markerclusterer',
                    src: ['**'],
                    dest: 'web/js/libs/markerclusterer'},
                {cwd: 'node_modules/leaflet/dist',
                    src: ['**'],
                    dest: 'web/js/libs/leaflet'},
                {cwd: 'node_modules/leaflet.markercluster/dist',
                    src: ['**'],
                    dest: 'web/js/libs/leaflet.markercluster'},
                {cwd: 'node_modules/leaflet.fullscreen',
                    src: ['**'],
                    dest: 'web/js/libs/leaflet.fullscreen'},
                {cwd: 'node_modules/datatables.net',
                    src: ['**'],
                    dest: 'web/js/libs/datatables.net'},
                {cwd: 'node_modules/datatables.net-dt',
                    src: ['**'],
                    dest: 'web/js/libs/datatables.net-dt'},
                {cwd: 'node_modules/jstree/dist',
                    src: ['**'],
                    dest: 'web/js/libs/jstree'}
            ]
        },
